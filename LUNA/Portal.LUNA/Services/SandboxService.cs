...
public class SandboxService : ISandboxService
{
    ...
    {
        var userApiKey = await _db.UserApiKeys.FirstOrDefaultAsync(k => k.ApiKey == apiKey && k.RevokedAt == null)
    ...
    public async Task<bool> DestroyAsync(string sandboxId, string apiKey)
    {
        ...
        var sandbox = await _db.Sandboxes.FirstOrDefaultAsync(s => s.Id == sandboxId && s.UserApiKeyId == userApiKey.Id && s.DestroyedAt == null);
    ...
    public async Task<SandboxDto?> GetAsync(string sandboxId, string apiKey)
    {
        ...
        var sandbox = await _db.Sandboxes.FirstOrDefaultAsync(s => s.Id == sandboxId && s.UserApiKeyId == userApiKey.Id);
