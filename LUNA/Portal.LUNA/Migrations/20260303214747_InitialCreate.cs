    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailableMcpServers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserApiKeys_AvailableMcpServers_McpServerId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    UserApiKeyId = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sandboxes_UserApiKeys_UserApiKeyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserApiKeySettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserApiKeySettings_UserApiKeys_UserApiKeyId",
                        column: x => x.UserApiKeyId,
                        principalTable: "UserApiKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableMcpServers_Name",
                table: "AvailableMcpServers",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Sandboxes_UserApiKeyId",
                table: "Sandboxes",
                column: "UserApiKeyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserApiKeys_McpServerId",
                table: "UserApiKeys",
                column: "McpServerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserApiKeySettings_UserApiKeyId",
                table: "UserApiKeySettings",
                column: "UserApiKeyId");
        }
