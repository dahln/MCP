    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_McpContainerInstances", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemEmailAddress = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    PortalRootUrl = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserApiKeyKvps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserApiKeyKvps_UserApiKeys_ApiKeyId",
                        column: x => x.ApiKeyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserApiKeyKvps_ApiKeyId",
                table: "UserApiKeyKvps",
                column: "ApiKeyId");
        }
